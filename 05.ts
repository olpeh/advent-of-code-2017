...
const calculate = input => {
  while (currentIndex >= 0 && currentIndex <= maxIndex) {
    step++;
    const currentJump = input[currentIndex];
    input[currentIndex]++;
...
const calculatePart2 = input => {
  while (currentIndex >= 0 && currentIndex <= maxIndex) {
    step++;
    const currentJump: number = input[currentIndex];
    currentJump >= 3 ? input[currentIndex]-- : input[currentIndex]++;
    currentIndex += currentJump;
  }
  return step;
};
